...
def main() -> int:
    ...
    parser.add_argument("--sandbox", default=None, help="sandbox dir (default: temp dir)")
    parser.add_argument("--verify", default=None, help="verification command template, {file} = game file")
    parser.add_argument("--game", default=None, help="game file name")
    parser.add_argument("--max-turns", type=int, default=None)
    parser.add_argument("--log", default=None, help="event log JSONL path")
